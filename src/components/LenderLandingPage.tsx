            ...
            <div className="p-6">
              ...
              {submitted ? (
                ...
                <div id="mc_embed_shell">
                  ...
                  <div id="mc_embed_signup">
                    <form action="https://travelclothingclub.us9.list-manage.com/subscribe/post?u=76ec7acb17d86542fbeae7fae&amp;id=451cee46ca&amp;f_id=00321ae1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" onSubmit={handleEmailSubmit}>
                      <div id="mc_embed_signup_scroll">
                        <h2>Be the First to Start Lending</h2>
                        <div className="indicates-required">Get early access to our lender platform and start earning from your travel wardrobe</div>
                        <div className="mc-field-group">
                          <label htmlFor="mce-EMAIL">Email Address <span className="asterisk">*</span></label>
