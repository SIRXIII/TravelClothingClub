          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
            {submitted ? (
              ...
              <form onSubmit={handleEmailSubmit} className="text-center">
                <h3 className="text-xl font-semibold mb-4">Be the First to Use In-Site AI Try-On</h3>
                <p className="text-slate-600 mb-6">Get early access to our integrated AI try-on feature and boost your rental rates</p>
            ...
            <div className="p-6">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-4">
                  <h3 className="text-lg font-medium">Be the First to Start Lending</h3>
                  <p className="text-slate-600">Get early access to our lender platform and start earning from your travel wardrobe</p>
                  <input
                    type="email"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
